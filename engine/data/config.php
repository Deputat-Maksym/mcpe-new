...
'home_title' => 'Minecraft: моды, карты, текстуры  для MCPE 1.15, 1.14, 1.13, 1.12, 1.11, 1.10',

'http_home_url' => 'https://mcpe-new.ru/',

'only_ssl' => '1',

'description' => 'У нас есть крутые моды для Minecraft PE, классные карты для игры с друзьями, клёвые текстуры для МКПЕ и многое другое для Майнкрафт Pocket Edition 1.14, 1.13, 1.12, 1.11, 1.10, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4.',

'keywords' => 'minecraft, майнкрафт',

'short_title' => 'mcpe-new.ru',
...
'admin_mail' => 'vseocomputere@yandex.ru',
...
'tinypng_key' => 'EwDj0Hs_H1vDJ9YGQf81MOvHTfd9_pry',
