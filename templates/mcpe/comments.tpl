<div class="comment" id="{comment-id}">
	<div class="com_info">
		...
		<div class="meta-sect">
			...
			<ul class="left">
				<li class="" title="Цитировать">[fast]<span>Цитировать</span>[/fast]</li>
				[treecomments]
				<li class="" title="Ответить">[reply]<span>Ответить</span>[/reply]</li>
				[/treecomments]
				<li class="compl" title="Жалоба">[complaint]<span class="title_hide">Жалоба</span>[/complaint]</li>
				[not-group=5]
